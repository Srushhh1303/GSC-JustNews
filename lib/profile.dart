  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        SizedBox(
          height: 10,
        ), // Add spacing between the text and the profile image
        CircleAvatar(
          radius: 70, // Adjust the size of the circle avatar as needed
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        mapData["headline"],
                        style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18), // Headline in bold, white color, and larger font size
                      ),
                      SizedBox(height: 10),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text(
                            mapData["date"],
                            style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold), // Date in white color
                          ),
                          Text(
                            mapData["time"],
                            style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold), // Time in white color
                          ),
                        ],
                      ),
                      SizedBox(height: 10),
