...
class _NewsPostScreenState extends State<NewsPostScreen> {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text("Your article has been submitted for review. Thank you for contributing!"),
          actions: [
            TextButton(
              onPressed: () {
                Navigator.pop(context); // Close the dialog
               // Navigator.pop(context); // Close the NewsPostScreen
              },
  ...
  void addPost() async {
    ...
    _ref.child(userid).child(id).set(
      ...
      showSubmissionDialog(context); // Show submission dialog
